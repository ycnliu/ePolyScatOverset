# Define file paths
manualDir="./manual"
frontHtml="$manualDir/front.html"
manualHtml="$manualDir/manual.html"
diffHtml="$manualDir/DiffE3to2020.html"
#
cat <<eoi >./manual/manual.html
...
<html>
  ...
  <frameset cols="20%,*" framespacing="1" frameborder="yes" border="1" bordercolor="#333333">
    <frame src="contents.html" name="contents" scrolling="NO" noresize>
    <frame src="front.html" name="material">
  </frameset>
  <noframes><body>
  </body></noframes>
</html>
...
<HTML>
  ...
  <BODY LINK=navy VLINK=navy BGCOLOR="#FFFFCC">
    ...
    <center>
      ...
      <h2>(Complex Kohn Version)</h2>

      <h2>Date: ${GITDATE}</h2>
      <h2>Commit: ${GITSHA1:0:7}</h2>
      <br /><br />
      <h2>Complex Kohn version: L. Greenman, C. W. McCurdy, and R. R. Lucchese </h2>
      <h2>Schwinger version: R. R. Lucchese, N. Sanna, A. P. P. Natalense, and F. A. Gianturco </h2>
      <h2>RotOrientAsym: J. Lopez Dominguez<h2>
      <br />
      <p>
